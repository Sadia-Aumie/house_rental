...
INSERT INTO `add_property` (`property_id`, `country`, `Division`,  `district`, `city`, `vdc_municipality`, `ward_no`, `tole`, `contact_no`, `property_type`, `estimated_price`, `total_rooms`, `bedroom`, `living_room`, `kitchen`, `bathroom`, `description`, `latitude`, `longitude`, `owner_id`) VALUES
(123, 'Bangladesh', 'Rajshahi',  'Rajshahi', 'Rajsahi', 'Municipality', 3, '1', 1712155902, 'Full House Rent', 2000000, 2, 3, 3, 3, 3, 'lakeside', '27.679130', '85.327872', 1),
(124, 'Bangladesh', 'Bogura', 'Bogura', 'Bogura', 'Municipality', 14, 'Lakeside', 9803480519, 'Full House Rent', 2000000, 15, 5, 2, 2, 7, 'This is a beautiful property located near Lakeside, .', '27.679130', '85.327872', 1);
